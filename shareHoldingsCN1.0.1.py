...
reg = '''\
<tr>\
<tdclass="col-stock-code">\
<divclass="mobile-list-heading">(.*?)</div>\
<divclass="mobile-list-body">(.*?)</div></td>\
<tdclass="col-stock-name">\
<divclass="mobile-list-heading">(.*?)</div>\
<divclass="mobile-list-body">(.*?)</div></td>\
<tdclass="col-shareholding">\
<divclass="mobile-list-heading">(.*?)</div>\
<divclass="mobile-list-body">(.*?)</div></td>\
<tdclass="col-shareholding-percent">\
<divclass="mobile-list-heading">(.*?)</div>\
<divclass="mobile-list-body">(.*?)</div></td>\
</tr>\
'''
...
file_saved = 'ShareholdingCN_{}_{}_at_{}.xls'.format(start, end, date_time)
